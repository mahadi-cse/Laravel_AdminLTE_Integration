...
@section('title', 'My New Customized Dashboard')

@section('breadcrumb-title', 'This is breadcrumb-title Dashboard')

@section('option-title', 'This is option-title Dashboard')

@section('content')
    --- This is content of dashboard page ---
    <hr>
